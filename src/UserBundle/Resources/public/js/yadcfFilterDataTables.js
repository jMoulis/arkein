/**
 * Created by julienmoulis on 17/03/2017.
 */
/*!
                ...
                if (args.hasOwnProperty(columnObjKey)) {
                    ...
                    if ($filter_selector.length === 1) {
                        ...
                        if (columnObj.filter_type === "select" || columnObj.filter_type === 'custom_func') {
                            ...
                            //add a wrapper to hold both filter and reset button
                            $(filter_selector_string).append("<div id=\"yadcf-filter-wrapper-" + table_selector_jq_friendly + "-" + column_number + "\" class=\"yadcf-filter-wrapper form-inline\"></div>");
                            filter_selector_string = filter_selector_string + " div.yadcf-filter-wrapper";
                            ...
                            //add a wrapper to hold both filter and reset button
                            $(filter_selector_string).append("<div id=\"yadcf-filter-wrapper-" + table_selector_jq_friendly + "-" + column_number + "\" class=\"yadcf-filter-wrapper btn-group\"></div>");
                            filter_selector_string = filter_selector_string + " div.yadcf-filter-wrapper";
