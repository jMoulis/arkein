 ...
 */
class Version20170320055154 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE date date DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE date date DATE DEFAULT NULL');
    }
}
