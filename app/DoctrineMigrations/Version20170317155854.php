 ...
 */
class Version20170317155854 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ticket DROP lieu');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD lieu VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci');
    }
}
